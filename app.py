...
container_name = "commoncontainer" # container name in which images will be store in the storage account
                ...
                <div class="form-group">
                    <form method="post" action="/upload-file" 
                        ...
                        <div style="display: flex;">
                            <input type="file" accept=".png, .jpeg, .jpg, .gif, .pdf" name="file" multiple class="form-control" style="margin-right: 1em;">
